...
import { FlatLoader } from '@components'
  ...
  return (
    <SecurityContainer>
      <SecuritySummary>
        <SecurityHeader>
          <FormattedMessage
            id='scenes.preferences.email.loading.title'
